...
public class CSV2Metadata {
    ...
    private int parse(File csvDocument, File folder, String filenameColumn, String rootElement, String rootPrefix, String rootNamespace) throws Exception {
        ...
        final String CLD_NS = "xmlns:xsi=\"http://purl.org/cld/terms/\"";
        ...
        while (recordItor.hasNext()) {
            ...
            File xmlFile = new File(folder, String.format("%s.xml", filename));
            ...
            String root = String.format("%s:%s xmlns:%s=\"%s\" %s %s", rootPrefix, rootElement, rootPrefix, rootNamespace, DCTERMS_NS, CLD_NS, XSI_NS);
            ...
            for (int i = 0; i < headerCount; i++) {
                ...
                boolean isDublinCore = (header.startsWith("dc:") || header.startsWith("dcterms:") || header.startsWith("cld"));
                if (isDublinCore) {
